...
describe LangRegex::Converter::TypeConverter do
  it 'escapes the supported sequences in Java', targets: [JAVA] do
    expect(/\d\D\s\S\w\W/).to become(/\\d\\D\\s\\S\\w\\W/)
  end
  ...
  it 'substitutes the hex type "\h" with an equivalent set', targets: [ES2009, ES2015, JAVA, PHP, PYTHON] do
    expect(/\h+/).to\
    become(/[0-9A-Fa-f]+/).and keep_matching('f').and keep_not_matching('x')
  end

  it 'substitutes the hex type "\h" with an equivalent set in i-mode', targets: [ES2009, ES2015, JAVA, PHP, PYTHON] do
    expect(/\h+/i).to\
  ...
  it 'substitutes the nonhex type "\H" with an equivalent set', targets: [ES2009, ES2015, JAVA, PHP, PYTHON] do
    expect(/\H+/).to\
    become(/[^0-9A-Fa-f]+/).and keep_matching('x').and keep_not_matching('f', 'F')
  end

  it 'substitutes the nonhex type "\H" with an equivalent set in i-mode', targets: [ES2009, ES2015, JAVA, PHP, PYTHON] do
    expect(/\H+/i).to\
  ...
  it 'drops the extended grapheme type "\X" with warning', targets: [ES2009, ES2015, JAVA, PHP, PYTHON] do
    expect(/a\Xb/).to\
    become(/ab/)
